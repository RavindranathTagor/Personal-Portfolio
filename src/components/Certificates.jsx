...
const certifications = [
  {
    ...
    description: "Foundational knowledge of Oracle Fusion Cloud HCM.",
  ...
  },
  {
    ...
    description: "Foundational knowledge of cloud concepts, core Azure services, security, and pricing.",
...
const Certificates = () => {
  ...
  return (
    <section id="certificates" className="py-12 sm:py-16 md:py-20 bg-neutral-900">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Professional Certifications</h2>
          <div className="w-20 h-1 bg-white mx-auto"></div>
          <p className="text-gray-400 mt-4 text-sm sm:text-base px-4">Industry-recognized credentials validating technical expertise</p>
        </motion.div>
